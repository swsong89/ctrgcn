...
class MultiScale_TemporalConv(nn.Module):
    def __init__(self,
        ...
        mid_channels = out_channels // self.num_branches   # 10,10,10
        rem_mid_channels = out_channels - mid_channels * (self.num_branches  - 1)  # 14
        ...
        self.branches.append(nn.Sequential(
            ...
            nn.BatchNorm2d(mid_channels)  # 为什么还要加bn
        ))

        self.branches.append(nn.Sequential(
            nn.Conv2d(in_channels, rem_mid_channels, kernel_size=1, padding=0, stride=(stride,1)),
