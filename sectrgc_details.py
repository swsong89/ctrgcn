...
Model(
  ...
  (l1): TCN_GCN_unit(
    (tem_embed): embed(
      (cnn): Sequential(
        (0): cnn1x1(
          (cnn): Conv2d(64, 64, kernel_size=(1, 1), stride=(1, 1), bias=False)
        )
        (1): ReLU()
        (2): cnn1x1(
          (cnn): Conv2d(64, 64, kernel_size=(1, 1), stride=(1, 1), bias=False)
    ...
    (gcn1): unit_gcn(
      (convs): ModuleList(
        (0): SECTRGC(
          ...
          (tanh): Tanh()
          (dr_joint_spa): DRJointSpa(
            (spa_embed): embed(
              (cnn): Sequential(
                (0): cnn1x1(
                  (cnn): Conv2d(25, 64, kernel_size=(1, 1), stride=(1, 1))
                )
                (1): ReLU()
                (2): cnn1x1(
            ...
            (gcn): gcn_spa(
              ...
              (relu): ReLU()
              (w): cnn1x1(
                (cnn): Conv2d(128, 64, kernel_size=(1, 1), stride=(1, 1), bias=False)
              )
              (w1): cnn1x1(
                (cnn): Conv2d(128, 64, kernel_size=(1, 1), stride=(1, 1))
              )
            )
          )
        )
  ...
  (l5): TCN_GCN_unit(
    (tem_embed): embed(
      (cnn): Sequential(
        ...
        (1): ReLU()
        (2): cnn1x1(
          (cnn): Conv2d(64, 128, kernel_size=(1, 1), stride=(1, 1), bias=False)
        )
        (3): ReLU()
      )
    )
  ...
  (l6): TCN_GCN_unit(
    (tem_embed): embed(
      (cnn): Sequential(
        (0): cnn1x1(
          (cnn): Conv2d(32, 64, kernel_size=(1, 1), stride=(1, 1), bias=False)
        )
        (1): ReLU()
        (2): cnn1x1(
          (cnn): Conv2d(64, 128, kernel_size=(1, 1), stride=(1, 1), bias=False)
  ...
  (l8): TCN_GCN_unit(
    (tem_embed): embed(
      (cnn): Sequential(
        ...
        (1): ReLU()
        (2): cnn1x1(
          (cnn): Conv2d(64, 256, kernel_size=(1, 1), stride=(1, 1), bias=False)
        )
        (3): ReLU()
      )
    )
  ...
  (l9): TCN_GCN_unit(
    (tem_embed): embed(
      (cnn): Sequential(
        (0): cnn1x1(
          (cnn): Conv2d(16, 64, kernel_size=(1, 1), stride=(1, 1), bias=False)
        )
        (1): ReLU()
        (2): cnn1x1(
          (cnn): Conv2d(64, 256, kernel_size=(1, 1), stride=(1, 1), bias=False)
